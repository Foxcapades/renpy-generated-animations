...
def generate_animation(directory, **kwargs):
    ...
    [ file01.png, file02.png, file03.png, ... ] or
    [ 01.png, 02.png, 03.png, ...]

    Arguments
    ---------
    directory : str
        The directory containing the animation frames.  This path is relative to
        the game directory.  For example, a path may look like:
        "images/animations/explosion".

    Keyword Arguments
    -----------------
    fps : int|float
        Frames per second for the animation.  Incompatible with the `pause`
        keyword argument.  Setting both will cause an error.

        Defaults to 30.

    pause : float
        How long to pause between each frame.  Incompatible with the `fps`
        keyword argument.  Setting both will cause an error.
    ...
    -------
    image_name : str
        Name of the generated animation.
    """
